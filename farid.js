    ...
    currentDomain: 'yclients.com',
        ...
        sdkSource: 'https://n952865.yclients.com' + '/js-sdk/sdk.min.js',
        analyticUdidStoreKey: "analytics-udid",

        showNewWidgetAutomatically: false,
        initialized: false,
		id: '952865',
		href: 'https://b952865.yclients.com/',
        script_href: 'https://w952865.yclients.com',
		lang: 'rus',
		isNew: '1',
	...
	reachButtonPressGoal : function() {
      ...
      loadSuperButton: function() {
        ...
        window.yClientsWidgetOptions = {
            target: outlet,
            widgetBaseUrl: 'https://n952865.yclients.com',
            companyId: '837880',
            widgetId: '952865',
        ...
        script.setAttribute('src', 'https://n952865.yclients.com/superbutton/superbutton.umd.min.js');
